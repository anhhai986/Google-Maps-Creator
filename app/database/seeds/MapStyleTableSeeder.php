...
class MapStyleTableSeeder extends Seeder {

    public function run()
    {
        DB::table('map_styles')->delete();

        \GMC\Model\MapStyle::create(array(
            'thumb' => 'default.png',
            'style' => ''
        ));

        \GMC\Model\MapStyle::create(array(
            'thumb' => 'subtle-grayscale.png',
